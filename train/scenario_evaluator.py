...
class DomainEvaluator:
    ...
    def save_overall(self, folder_name):
        ...
        latex_txt = f"${self.avg_ACC.average()* 100:.2f} \\pm ${self.avg_ACC.standard_deviation()* 100:.2f} \
            ${self.avg_BWT.average()* 100:.2f} \\pm ${self.avg_BWT.standard_deviation()* 100:.2f} \
            ${self.avg_FWT.average()* 100:.2f} \\pm ${self.avg_FWT.standard_deviation()* 100:.2f}"
