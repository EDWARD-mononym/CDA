...
class DSAN_Conditional_Memory(BaseAlgo):
    """
    ...
    def __init__(self, configs) -> None:
        ...
        # Added conditional entropy loss
    ...
    def epoch_train(self, src_loader, trg_loader, epoch, device):
        ...
        for step, (data) in enumerate(combined_loader):
            ...
            cond_loss = self.criterion_cond(trg_pred)
            ...
            loss = (1-alpha) * self.hparams.domain_loss_wt * domain_loss + alpha * self.hparams.src_cls_loss_wt * cond_loss + \
            ...
            if memory:
                ...
                mem_cond_loss = self.criterion_cond(trg_pred)


                loss += self.hparams.domain_loss_wt * mem_domain_loss + self.hparams.src_cls_loss_wt * mem_cond_loss
