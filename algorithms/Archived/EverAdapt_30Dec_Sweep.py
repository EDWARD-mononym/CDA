...
class EverAdapt_30Dec_Sweep(BaseAlgo):
    ...
    def epoch_train(self, src_loader, trg_loader, epoch, device):
        ...
        for step, (data) in enumerate(combined_loader):
            ...
            # global_wt = self.configs.global_loss_wt
            entropy_wt = self.configs.entropy_loss_wt
            ...
            # global_loss = CORAL(src_feat, trg_feat)
            # calculate source classification loss
            src_cls_loss = self.cross_entropy(src_pred, src_y)

            # calculate the total loss
            # loss = global_wt * global_loss + local_wt * domain_loss + entropy_wt * cond_ent_loss + src_cls_loss
            ...
            if memory:
                ...
                mem_loss = self.configs.local_loss_wt * mem_domain_loss
