...
class EverAdapt_NoCBN_NoDynamic(BaseAlgo):
    ...
    def epoch_train(self, src_loader, trg_loader, epoch, device):
        ...
        for step, (data) in enumerate(combined_loader):
            ...
            loss = self.hparams.domain_loss_wt * domain_loss + self.hparams.src_cls_loss_wt * coral_loss + self.hparams.src_cls_loss_wt * src_cls_loss 
