...
class EverAdapt_NoGlobal(BaseAlgo):
    ...
    def epoch_train(self, src_loader, trg_loader, epoch, device):
        ...
        for step, (data) in enumerate(combined_loader):
            ...
            loss = alpha * self.hparams.domain_loss_wt * domain_loss +  (1-alpha) * self.hparams.src_cls_loss_wt * src_cls_loss 
            # loss = alpha * domain_loss +  (1-alpha)  * src_cls_loss 
            ...
            if memory:
                ...
                # mem_loss = alpha * mem_domain_loss
