...
class FDTrain(DomainTrainer):
    ...
    def save_run_results(self, scenario, run):
        ...
        file_name = os.path.join(os.getcwd(), f'results/{self.configs.Dataset_Name}/{self.args.experiment}/{self.args.algo}/{scenario}/Run_{run}')
...
def parse_arguments():
    ...
    # ========= Select the algoritm ==============
    parser.add_argument("--algo", default="EverAdapt", help="Algorithm to use: CDAN, DANN, DeepCORAL, DSAN, MMDA")
    # ========= Experiment settings ===============
